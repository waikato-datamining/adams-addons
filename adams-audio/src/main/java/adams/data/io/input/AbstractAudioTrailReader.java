 ...
 */
public abstract class AbstractAudioTrailReader
  extends AbstractDataContainerReader<AudioTrail> {
  ...
  public static String[] getReaders() {
    return ClassLister.getSingleton().getClassnames(AbstractAudioTrailReader.class);
  }
}
