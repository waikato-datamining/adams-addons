...
public class GetKeyFromKeyPair
  ...
  public Class[] generates() {
    return new Class[]{java.security.Key.class};
  }
  ...
  protected String doExecute() {
    ...
    switch (m_Type) {
      case PUBLIC:
	m_OutputToken = new Token(pair.getPublic());
	break;
      case PRIVATE:
	m_OutputToken = new Token(pair.getPrivate());
	break;
      default:
