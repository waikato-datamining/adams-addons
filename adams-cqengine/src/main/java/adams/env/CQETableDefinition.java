...
/**
 * Definition for the CQE Table props file.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class CQETableDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "cqe table";
  ...
  public String getFile() {
    return AbstractCQETable.FILENAME;
  }
