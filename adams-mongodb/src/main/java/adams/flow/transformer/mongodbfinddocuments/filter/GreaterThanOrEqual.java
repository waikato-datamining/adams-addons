...
/**
 * Value associated with the key in the document must be greater than or equal to the filter value.
 *
...
public class GreaterThanOrEqual
  ...
  public String globalInfo() {
    return "Value associated with the key in the document must greater than or equal to the filter value.";
  }
