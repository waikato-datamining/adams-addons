...
/**
 * Value associated with the key in the document must be less than or equal to the filter value.
 *
...
public class LessThanOrEqual
  ...
  public String globalInfo() {
    return "Value associated with the key in the document must less than or equal to the filter value.";
  }
