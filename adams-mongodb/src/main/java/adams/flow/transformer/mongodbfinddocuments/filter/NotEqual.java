...
/**
 * Value associated with the key in the document must not be equal to the filter value.
 *
...
public class NotEqual
  ...
  public String globalInfo() {
    return "Value associated with the key in the document must not be equal to the filter value.";
  }
