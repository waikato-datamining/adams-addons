...
/**
 <!-- globalinfo-start -->
 * Creates a new collection and forwards it.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- flow-summary-start -->
...
public class MongoDbNewCollection
  ...
  protected String queryDatabase() {
	...
	mongodb.createCollection(m_Collection);
	m_OutputToken = new Token(mongodb.getCollection(m_Collection));
      }
    }
    catch (Exception e) {
      result = handleException("Failed to create collection: " + m_Collection, e);
    }
