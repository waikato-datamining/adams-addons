...
/**
 <!-- globalinfo-start -->
 * Downloads the data associated with the incoming token and forwards it as byte array, if successful.<br>
...
public class DataExchangeServerDownload
  ...
  public String globalInfo() {
    return "Downloads the data associated with the incoming token and forwards "
      + "it as byte array, if successful.\n"
  ...
  protected String doExecute() {
    ...
    data   = DataExchangeHelper.download(token, getActualUrl(), m_Connection.getAuthentication(), errors);
