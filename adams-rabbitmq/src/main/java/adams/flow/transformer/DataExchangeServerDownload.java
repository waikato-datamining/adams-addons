...
/*
 * DataExchangeServerDownload.java
...
/**
 <!-- globalinfo-start -->
 * Downloads the data associated with the incoming token from the specified data exchange server and forwards it as byte array, if successful.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- flow-summary-start -->
 ...
 * &nbsp;&nbsp;&nbsp;default: DataExchangeServerDownload
 * </pre>
 *
...
public class DataExchangeServerDownload
  ...
  public String globalInfo() {
    return "Downloads the data associated with the incoming token from the specified data exchange server and forwards it as byte array, if successful.";
  }
