 ...
 * </pre>
 *
 * <pre>-action &lt;adams.flow.sink.redisaction.AbstractRedisAction&gt; (property: action)
 * &nbsp;&nbsp;&nbsp;The action to execute.
 * &nbsp;&nbsp;&nbsp;default: adams.flow.sink.redisaction.Null
 * </pre>
 *
 <!-- options-end -->
 *
...
public class RedisSink
  ...
  protected String doExecute() {
    ...
    try {
      result = m_Action.execute(m_Connection, m_InputToken.getPayload());
    }
    catch (Exception e) {
