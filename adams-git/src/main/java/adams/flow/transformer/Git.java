...
import adams.flow.transformer.git.AbstractGitOperation;
import adams.flow.transformer.git.Add;

/**
 <!-- globalinfo-start -->
 * Performs the specified git operation on the incoming data and forwards its output
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- flow-summary-start -->
 ...
 * </pre>
 *
 * <pre>-operation &lt;adams.flow.transformer.git.AbstractGitOperation&gt; (property: operation)
 * &nbsp;&nbsp;&nbsp;The operation to perform.
 * &nbsp;&nbsp;&nbsp;default: adams.flow.transformer.git.Add
 * </pre>
 *
 <!-- options-end -->
 *
...
public class Git
  ...
  public String globalInfo() {
    return "Performs the specified git operation on the incoming data and forwards its output";
  }
  ...
  protected String doExecute() {
	...
	errors.clear();
	output = m_Operation.execute(input, errors);
	if (errors.isEmpty())
