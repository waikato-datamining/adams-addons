...
\begin{table}[b]
	\begin{tabular}{c l l}
		\parbox[c][2cm]{2cm}{\copyright 2024-2026} &
...
\begin{tight_itemize}
    \item \textit{GitRepo} -- for specifying a git repository's location
\end{tight_itemize}
The following source actors are available:
\begin{tight_itemize}
    \item \textit{Git} -- performs the specified git operation and forwards its output.
\end{tight_itemize}
The following transformers are available:
\begin{tight_itemize}
    \item \textit{Git} -- performs the specified git operation on the incoming data and forwards its output.
\end{tight_itemize}
