...
import adams.gui.visualization.object.tools.SAM2;
...
/**
 * Annotator plugin that works only in conjunction with the SAM2 tool.
 *
 * @author fracpete (fracpete at waikato dot ac dot nz)
 */
public class SAM2Markers
  ...
  public String globalInfo() {
    return "Annotator plugin that works only in conjunction with the SAM2 tool.\n"
