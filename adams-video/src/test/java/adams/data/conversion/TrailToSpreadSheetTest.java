...
/**
 * Tests the TrailToSpreadSheet conversion.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class TrailToSpreadSheetTest
   ...
   */
  public TrailToSpreadSheetTest(String name) {
    super(name);
  }
  ...
  protected Object[] getRegressionInput() {
    ...
    reader.setInput(new TmpFile("mouse1.trail"));
    trail = reader.read().get(0);
