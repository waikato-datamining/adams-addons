...
public class ExtractBackgroundDialog extends ApprovalDialog {
  ...
  protected AbstractMovieImageSampler m_ImageSampler;
  ...
  protected void initGUI() {
    ...
    m_ImageSampler = (AbstractMovieImageSampler) m_ImageSamplerSelectionPanel.getCurrent();
    m_ImageSamplerSelectionPanel.addChangeListener(e -> m_ImageSampler =
      (AbstractMovieImageSampler) m_ImageSamplerSelectionPanel.getCurrent());
  ...
  protected void extractBackground() {
    BufferedImageContainer[] imageContainers = ((AbstractBufferedImageMovieImageSampler)(m_ImageSampler))
      .sample(m_CurrentFile);
