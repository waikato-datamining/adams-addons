 ...
 * &nbsp;&nbsp;&nbsp;If enabled, the sample images get output as array rather than one-by-one.
 * &nbsp;&nbsp;&nbsp;default: false
 * </pre>
 * 
 * <pre>-sampler &lt;adams.flow.transformer.movieimagesampler.AbstractMovieImageSampler&gt; (property: sampler)
 * &nbsp;&nbsp;&nbsp;The sampler algorithm to use for generating the sample images from the movie.
 * &nbsp;&nbsp;&nbsp;default: adams.flow.transformer.movieimagesampler.FixedIntervalBufferedImageSampler
 * </pre>
 * 
 <!-- options-end -->
 *
...
public class MovieImageSampler
  ...
  public void defineOptions() {
    ...
    m_OptionManager.add(
      "sampler", "sampler",
      new FixedIntervalBufferedImageSampler());
  }
  ...
  public String getQuickInfo() {
    return QuickInfoHelper.toString(this, "sampler", m_Sampler);
  }
  ...
  protected String doExecute() {
    ...
    AbstractImageContainer[]	samples;
    ...
    try {
      samples = m_Sampler.sample(file);
      if (samples != null)
	m_Queue.addAll(Arrays.asList(samples));
    }
    catch (Exception e) {
      result = handleException("Failed to sample movie file: " + file, e);
    }
