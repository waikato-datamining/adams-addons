...
/**
 <!-- globalinfo-start -->
 * Saves a trail to disk with the specified writer and passes the absolute filename on.<br>
 ...
 */
public class TrailFileWriter
  extends AbstractDataContainerFileWriter<Trail> {
  ...
  public String globalInfo() {
    return
        "Saves a trail to disk with the "
