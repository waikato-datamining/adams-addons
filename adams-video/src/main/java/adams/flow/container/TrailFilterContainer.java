...
public class TrailFilterContainer
  ...
  protected void initFilterHelp() {
    addHelp(VALUE_INPUT, "input object; " + Utils.classesToString(new Class[]{Trail.class, Trail[].class}));
    addHelp(VALUE_FILTER, "filter object; " + Filter.class.getName());
    addHelp(VALUE_DATA, "data object; " + Utils.classesToString(new Class[]{Trail.class, Trail[].class}));
  }
}
