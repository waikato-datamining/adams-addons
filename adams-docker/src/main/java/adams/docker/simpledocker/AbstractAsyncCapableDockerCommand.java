...
/*
 * AbstractAsyncCapableDockerCommand.java
...
/**
 * Ancestor for docker commands that can be run in blocking or async mode.
 *
 * @author fracpete (fracpete at waikato dot ac dot nz)
 */
public abstract class AbstractAsyncCapableDockerCommand
  ...
  protected Object doAsyncExecute() {
	...
	try {
	  ...
	  LoggingHelper.handleException(
	    AbstractAsyncCapableDockerCommand.this,
