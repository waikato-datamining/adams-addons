 ...
 * @version $Revision$
 */
public class MekaWSTrainClassifier 
extends AbstractTransformer{
  ...
  public String globalInfo() {
    return "Trains a classifier on a dataset and makes the model available, using the Meka web-service.";
  }
  ...
  protected String doExecute() {
    nz.ac.waikato.adams.webservice.meka.TrainClassifier t =  new nz.ac.waikato.adams.webservice.meka.TrainClassifier();
