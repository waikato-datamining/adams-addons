 ...
 * @version $Revision$
 */
public class MekaWSPredictClassifier 
extends AbstractTransformer{
  ...
  public String globalInfo() {
    return "Performs predictions using a previously trained model, using the Meka web-service.";
  }
  ...
  protected String doExecute() {
    nz.ac.waikato.adams.webservice.meka.PredictClassifier p = new nz.ac.waikato.adams.webservice.meka.PredictClassifier();
