 ...
 * @version $Revision$
 */
public class MekaWSDownloadClassifier 
  ...
  public String globalInfo() {
    return "Downloads a previously trained model, using the Meka web-service.";
  }
  ...
  protected String doExecute() {
    nz.ac.waikato.adams.webservice.meka.DownloadClassifier p = new nz.ac.waikato.adams.webservice.meka.DownloadClassifier();
