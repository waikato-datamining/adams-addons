...
/**
 * Tests the MOARegressorSetup actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class MOARegressorSetupTest
   ...
   */
  public MOARegressorSetupTest(String name) {
    super(name);
  }
  ...
  public Actor getActor() {
    ...
    cts.setOutputInterval(40);  // 40 is the number of instances in the dataset
  ...
  public static Test suite() {
    return new TestSuite(MOARegressorSetupTest.class);
  }
