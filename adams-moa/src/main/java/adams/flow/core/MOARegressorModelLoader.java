 ...
 */
public class MOARegressorModelLoader
  extends AbstractModelLoader<Regressor> {
  ...
  public String globalInfo() {
    return "Manages MOA Regressor models.";
  }
  ...
  protected Object deserializeFile(MessageCollection errors) {
    ...
    try {
      ...
      if (result == null)
        errors.add("Failed to locate a " + Utils.classToString(Regressor.class)
   ...
   */
  @Override
  protected Regressor getModelFromContainer(AbstractContainer cont, MessageCollection errors) {
    if (cont instanceof WekaModelContainer)
      return (Regressor) cont.getValue(WekaModelContainer.VALUE_MODEL);
