...
/**
 * Ancestor for schemes that transmit data in some fashion.
 * 
...
public abstract class AbstractTransmitter
  ...
  implements Transmitter, ShallowCopySupporter<AbstractTransmitter>, Stoppable, QuickInfoSupporter {
  ...
  /**
   * Performs the actual transmission of data.
   * 
   * @throws Execption	if transmitting of data fails
   */
  protected abstract void doTransmit() throws Exception;
   ...
   */
  public AbstractTransmitter shallowCopy() {
   ...
   * @return		the shallow copy
   */
  public AbstractTransmitter shallowCopy(boolean expand) {
    return (AbstractTransmitter) OptionUtils.shallowCopy(this, expand);
  }
