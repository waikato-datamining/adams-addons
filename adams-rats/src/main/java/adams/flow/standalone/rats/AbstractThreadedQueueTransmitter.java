...
/**
 * AbstractThreadedQueueTransmitter.java
...
/**
 * Ancestor for transmitters that receive the incoming data from the flow's queue.
 * 
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public abstract class AbstractThreadedQueueTransmitter
  extends AbstractThreadedTransmitter {

  /** for serialization. */
  private static final long serialVersionUID = 1934564931032319528L;
