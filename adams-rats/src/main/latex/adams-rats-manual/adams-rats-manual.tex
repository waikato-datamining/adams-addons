...
\begin{itemize}
	\item \textit{RatsSetup} -- This standalone represents a complete setup
	of receivers and transmitters.
	\item \textit{RatsReceptions} -- Encapsulates all the separate reception
	setups.
	\item \textit{RatsReception} -- Defines a single reception setup.
	\item \textit{RatsTransmissions} -- Groups the transmission setups.
	\item \textit{RatsTransmission} -- Defines a single transmission setup.
\end{itemize}
