 ...
 * @version $Revision$
 */
public class WekaWSPredictClassifier 
extends AbstractTransformer{
  ...
  public String globalInfo() {
    return "Performs predictions using a previously trained model, using the Weka web-service.";
  }
