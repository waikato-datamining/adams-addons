...
extends AbstractWebServiceClientTransformer<CrossValidateClassifier, Dataset> {
  ...
  protected void doQuery() throws Exception {
    ...
    CrossValidateResponseObject returned = wekaService.crossValidateClassifier(m_CrossValidate.getDataset(), m_CrossValidate.getSeed(), m_CrossValidate.getFolds(), m_CrossValidate.getClassifier());
