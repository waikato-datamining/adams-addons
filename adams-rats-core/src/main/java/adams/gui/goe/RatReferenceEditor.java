...
import adams.core.option.parsing.RatReferenceParsing;
...
public class RatReferenceEditor
  ...
  public String toCustomStringRepresentation(Object obj) {
    return RatReferenceParsing.toString(null, obj);
  }
  ...
  public String getJavaInitializationString() {
    ...
    result = "new " + RatReference.class.getName() + "(\"" + Utils.backQuoteChars(getValue().toString()) + "\")";
  ...
  protected boolean isValid(String s) {
    return ((RatReference) getValue()).isValid(s);
  }
  ...
  protected boolean isUnchanged(String s) {
    return s.equals(((RatReference) getValue()).getValue());
  }
   ...
   *
   * @return		the located callable actors (including Rats nodes)
   */
  ...
  protected void initForDisplay() {
    ...
    m_TextValue.setToolTipText(((RatReference) getValue()).getTipText());

    m_Tree.setFlowTree(FlowHelper.getTree(m_CustomEditor));
    m_Tree.setItems(findRats());
    m_Tree.expandAll();
