...
public class DataSetIteratorWithScriptedConfiguration
  ...
  protected String loadScriptObject() {
    ...
    result = m_Handler.loadScriptObject(
      DataSetIteratorConfigurator.class,
      m_ScriptFile,
      m_ScriptOptions,
  ...
  protected String check() {
    ...
    if (result == null)
      m_DataSetIteratorConfiguratorObject = (DataSetIteratorConfigurator) m_ScriptObject;
  ...
  public void destroy() {
    ...
    m_DataSetIteratorConfiguratorObject = null;
  }
  ...
  public DataSetIterator configureDataSetIterator() {
    ...
    if (m_DataSetIteratorConfiguratorObject == null) {
      msg = check();
      if (msg != null)
	throw new IllegalStateException(msg);
    }
    if (m_DataSetIteratorConfiguratorObject != null)
      return m_DataSetIteratorConfiguratorObject.configureDataSetIterator();
    else
      throw new IllegalStateException("No dataset iterator generator available!");
  }

  /**
   * Instantiates the iterator if necessary.
   *
   * @return		the iterator
   * @see		#configureDataSetIterator()
   */
  protected synchronized DataSetIterator getDataSetIterator() {
    if (m_DataSetIterator == null)
      m_DataSetIterator = configureDataSetIterator();
    return m_DataSetIterator;
  }
