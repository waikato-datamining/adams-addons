...
/**
 * Abstract ancestor for input split generators that execute external scripts.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 13195 $
 */
public abstract class AbstractScriptedInputSplitConfigurator
  extends AbstractOptionHandler
  implements InputSplitConfigurator, FileBasedScriptingWithOptions {
