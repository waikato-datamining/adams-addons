...
/**
 * LibSvmRecordReaderConfigurator.java
...
/**
 <!-- globalinfo-start -->
 * Configures a org.canova.api.records.reader.impl.LibSvmRecordReader instance.
 * <br><br>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
 ...
 * @version $Revision$
 */
public class LibSvmRecordReaderConfigurator
