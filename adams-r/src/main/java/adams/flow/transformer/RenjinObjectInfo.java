 ...
 * &nbsp;&nbsp;&nbsp;If enabled, outputs the elements as array rather than one-by-one.
 * &nbsp;&nbsp;&nbsp;default: false
 * </pre>
 *
 * <pre>-type &lt;LENGTH|NUM_ROWS|NUM_COLUMNS|DIMENSIONS|DIMENSION_NAMES&gt; (property: type)
...
public class RenjinObjectInfo
  ...
  protected String doExecute() {
	...
	case DIMENSION_NAMES:
	  ...
	  if (dims.length > 0) {
	    for (i = 0; i < dims.length; i++)
	      m_Queue.add(RObjectHelper.getDimensionNames(input, i));
	  }
	  else {
	    getLogger().warning("No dimensions available!");
	  }
