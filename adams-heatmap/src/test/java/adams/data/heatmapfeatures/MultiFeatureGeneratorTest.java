...
/**
 * MultiFeatureGeneratorTest.java
...
/**
 * Tests the MultiFeatureGenerator feature generator.
 * 
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 6879 $
 */
public class MultiFeatureGeneratorTest
   ...
   */
  public MultiFeatureGeneratorTest(String name) {
    super(name);
  }
  ...
  protected AbstractHeatmapFeatureGenerator[] getRegressionSetups() {
    MultiFeatureGenerator[]		result;
    AbstractHeatmapFeatureGenerator[]	sub;

    result    = new MultiFeatureGenerator[2];
    result[0] = new MultiFeatureGenerator();
    result[1] = new MultiFeatureGenerator();
    sub = new AbstractHeatmapFeatureGenerator[5];
    sub[0] = new Min();
    sub[1] = new Max();
    sub[2] = new Mean();
    sub[3] = new StandardDeviation();
    sub[4] = new Histogram();
