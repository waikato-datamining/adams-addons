...
/**
 * Tests the MultiGenerator feature generator.
 * 
...
public class MultiGeneratorTest
   ...
   */
  public MultiGeneratorTest(String name) {
    super(name);
  }
  ...
  protected AbstractFeatureGenerator[] getRegressionSetups() {
    MultiGenerator[]	result;
    
    result    = new MultiGenerator[2];
    result[0] = new MultiGenerator();
    result[1] = new MultiGenerator();
    result[1].setSubGenerators(new AbstractFeatureGenerator[]{
	new Min(),
	new Max(),
	new Mean(),
    });
