...
public class HeatmapHistogram
  ...
  public String globalInfo() {
    return "Displays a histogram of a heatmap.";
  }
  ...
  public void defineOptions() {
    ...
    m_OptionManager.add(
	    "array-histogram", "arrayHistogram",
	    new ArrayHistogram());
  }
   ...
   */
  public String arrayHistogramTipText() {
    return "The setup for calculating the histogram.";
  }
  ...
  public void clearPanel() {
    ((HistogramPanel) m_Panel).setData(null);
  }
  ...
  public DisplayPanel createDisplayPanel(Token token) {
	...
	m_Panel = new HistogramPanel();
	m_Panel.setArrayHistogram((ArrayHistogram) m_ArrayHistogram.shallowCopy());
	m_Panel.setData((Heatmap) token.getPayload());
