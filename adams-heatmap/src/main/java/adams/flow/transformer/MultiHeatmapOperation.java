 ...
 * </pre>
 *
 * <pre>-operation &lt;adams.flow.transformer.multiheatmapoperation.AbstractMultiHeatmapOperation&gt; (property: operation)
 * &nbsp;&nbsp;&nbsp;The operation to apply to the incoming heatmaps.
 * &nbsp;&nbsp;&nbsp;default: adams.flow.transformer.multiheatmapoperation.PassThrough
 * </pre>
 *
 <!-- options-end -->
 *
...
public class MultiHeatmapOperation
  ...
  protected String doExecute() {
    ...
    if (m_InputToken.hasPayload(Heatmap[].class))
      maps = m_InputToken.getPayload(Heatmap[].class);
    else
    ...
    if (result == null) {
      ...
      try {
        output = m_Operation.process(maps, errors);
        if (!errors.isEmpty())
