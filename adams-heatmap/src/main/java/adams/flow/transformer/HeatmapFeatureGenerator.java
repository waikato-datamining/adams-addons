 ...
 * &nbsp;&nbsp;&nbsp;default: HeatmapFeatureGenerator
 * </pre>
 * 
 ...
 * </pre>
 * 
 * <pre>-algorithm &lt;adams.data.heatmapfeatures.AbstractHeatmapFeatureGenerator&gt; (property: algorithm)
 * &nbsp;&nbsp;&nbsp;The feature generation algorithm to use.
 * &nbsp;&nbsp;&nbsp;default: adams.data.heatmapfeatures.Max -converter \"adams.data.featureconverter.SpreadSheet -data-row-type adams.data.spreadsheet.DenseDataRow -spreadsheet-type adams.data.spreadsheet.SpreadSheet\"
 * </pre>
 * 
 <!-- options-end -->
 *
...
public class HeatmapFeatureGenerator
  ...
  public String globalInfo() {
    return
        "Applies a heatmap feature generator to the incoming heatmap and outputs "
   ...
   */
  public void setAlgorithm(AbstractHeatmapFeatureGenerator value) {
    m_Algorithm = value;
    reset();
  }
   ...
   */
  public AbstractHeatmapFeatureGenerator getAlgorithm() {
    return m_Algorithm;
  }
