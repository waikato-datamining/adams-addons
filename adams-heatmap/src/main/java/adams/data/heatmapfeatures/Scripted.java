...
public class Scripted
  ...
  protected String loadScriptObject() {
	...
	AbstractHeatmapFeatureGenerator.class,
	m_ScriptFile, 
	m_ScriptOptions, 
  ...
  protected void checkData(Heatmap map) {
    ...
    m_FeatureGeneratorObject = (AbstractHeatmapFeatureGenerator) m_ScriptObject;
  }
  /**
  ...
  public HeaderDefinition createHeader(Heatmap map) {
    return m_FeatureGeneratorObject.createHeader(map);
  }
  ...
  public List<Object>[] generateRows(Heatmap map) {
    return m_FeatureGeneratorObject.generateRows(map);
  }
