...
public class NamedSetup
  ...
  /** the actual scheme. */
  protected AbstractHeatmapFeatureGenerator m_ActualScheme;
  ...
  public String globalInfo() {
    return "Applies a hetmap feature generator that is referenced via its global setup name (see 'NamedSetups').";
  }
   ...
   */
  protected AbstractHeatmapFeatureGenerator getActualScheme() {
    if (m_ActualScheme == null) {
      m_ActualScheme = (AbstractHeatmapFeatureGenerator) m_Setup.getSetup();
      if (m_ActualScheme == null)
  ...
  public HeaderDefinition createHeader(Heatmap map) {
    return getActualScheme().createHeader(map);
  }
  ...
  public List<Object>[] generateRows(Heatmap map) {
    return getActualScheme().generateRows(map);
  }
}
