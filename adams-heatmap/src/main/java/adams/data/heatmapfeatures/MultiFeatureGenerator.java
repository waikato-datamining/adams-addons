 ...
 * </pre>
 * 
 * <pre>-sub-generator &lt;adams.data.heatmapfeatures.AbstractHeatmapFeatureGenerator&gt; [-sub-generator ...] (property: subGenerators)
 ...
 * @version $Revision$
 */
public class MultiFeatureGenerator
  ...
  public String globalInfo() {
    return 
	"Applies multiple generators to the same heatmap and merges the "
  ...
  public void defineOptions() {
    ...
    m_OptionManager.add(
	    ...
	    new AbstractHeatmapFeatureGenerator[0]);
   ...
   *
   * @param map		the image to act as a template
  ...
  public HeaderDefinition createHeader(Heatmap map) {
    ...
    for (i = 0; i < m_SubHeaders.length; i++) {
      m_SubHeaders[i] = m_SubGenerators[i].createHeader(map);
   ...
   *
   * @param map		the image to process
  ...
  public List<Object>[] generateRows(Heatmap map) {
    ...
    for (i = 0; i < m_SubGenerators.length; i++)
      sub[i] = m_SubGenerators[i].postProcessRows(map, m_SubGenerators[i].generateRows(map));
