...
public class HeatmapContainer
   ...
   */
  public HeatmapContainer(HeatmapContainerManager manager, Heatmap payload) {
  ...
  public void setID(String value) {
    ((Heatmap) getPayload()).setID(value);
  }
   ...
   */
  public String getID() {
    return ((Heatmap) getPayload()).getID();
  }
