...
\begin{table}[b]
	\begin{tabular}{c l l}
		\parbox[c][2cm]{2cm}{\copyright 2011-2025} &
...
\begin{tight_itemize}
  	...
  	calculated values.
  	\item \textit{ColumnCosineSimilarityToHeatmap} -- calculates the cosine
  	similarity between selected columns and generates a heatmap from the
    calculated values.
