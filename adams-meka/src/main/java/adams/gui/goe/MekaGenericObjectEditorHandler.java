...
/**
 * MekaGenericObjectEditorHandler.java
 ...
 */
public class MekaGenericObjectEditorHandler
  ...
  public boolean setClassType(PropertyEditor editor, Class cls) {
    ((meka.gui.goe.GenericObjectEditor) editor).setClassType(cls);
    return true;
  }
  ...
  public boolean setCanChangeClassInDialog(PropertyEditor editor, boolean canChange) {
    ((meka.gui.goe.GenericObjectEditor) editor).setCanChangeClassInDialog(canChange);
    return true;
  }
  ...
  public boolean getCanChangeClassInDialog(PropertyEditor editor) {
    return ((meka.gui.goe.GenericObjectEditor) editor).getCanChangeClassInDialog();
  }
  ...
  public boolean setValue(PropertyEditor editor, Object value) {
    ((meka.gui.goe.GenericObjectEditor) editor).setValue(value);
    return true;
  }
  ...
  public Object getValue(PropertyEditor editor) {
    return ((meka.gui.goe.GenericObjectEditor) editor).getValue();
  }
  ...
  public boolean handles(Class cls) {
    return (meka.gui.goe.GenericObjectEditor.class == cls);
  }
